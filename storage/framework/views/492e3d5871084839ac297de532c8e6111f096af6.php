...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/css/vendor.min.css">
    <link rel="stylesheet" href="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/vendor/icon-set/style.css">
    <link rel="stylesheet" href="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/css/custom.css">
    <!-- CSS Front Template -->
    ...
    <script
        src="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js"></script>
        ...
        <div class="col-md-12">
            <div id="loading" style="display: none;">
                <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                    <img width="200" src="<?php echo e(asset($assetPrefixPath . '/assets/admin/img/loader.gif')); ?>">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-12">
                            <center>
                                <h2 style="color: rgba(96,96,96,0.68)">
                                    <i class="tio-shopping-cart-outlined"></i> You have new booking, Check Please.
                                </h2>
                                <hr>
...
<script src="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/js/custom.js"></script>
...
<script src="<?php echo e(asset($assetPrefixPath . '/assets/admin')); ?>/js/sweet_alert.js"></script>
...
<audio id="myAudio">
    <source src="<?php echo e(asset($assetPrefixPath . '/assets/admin/sound/notification.mp3')); ?>" type="audio/mpeg">
</audio>
...
<?php /**PATH /opt/lampp/htdocs/brobo/resources/views/layouts/admin/app.blade.php ENDPATH**/ ?>