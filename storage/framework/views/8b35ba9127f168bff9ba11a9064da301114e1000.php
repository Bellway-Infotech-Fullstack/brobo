   ...
   <div class="outer_border">
      <div class="row">
         <div  class=" pull-left top_box p-4">
            ...
            <img src="<?php echo e($logoPath); ?>" height="100">		   
           ...
           <p>
            ...
            ?>
                Phone : <?php echo e(($phoneData) ? $phoneData->value : 'N/A'); ?> <br>
                Email : <?php echo e(($emailData) ? $emailData->value : 'N/A'); ?> <br>
      ...
      <div class="bg_color1" style="text-indent:10px;font-size: 14px;width: 50%;height: 26px;line-height: 18px; ">Booking Details - </div>
         <table height="82"  style="width:100%;margin-top:10px;" border="1" cellpadding="0" cellspacing="0">
            ...
            if(count($details) > 0){
               ...
               foreach ($details as $key => $detail){
                  ...
                  <td> Rs. <?php echo e($detail['item_price'] / $detail['quantity'] ?? ''); ?>   </td>
                  <td> Rs. <?php echo e($detail['item_price']); ?>  </td>                  
         ...
         <tr>
               ...
               <tr>
                  ...
                  <td align="right">  Rs.  <?php echo e($total_item_price); ?></td>
                  </tr>  

               <tr>
               <td> <strong> Delivery Fee : </strong>  </td>
               <td align="right">  Rs. <?php echo e($deliveryCharge); ?></td>
               </tr>  
               ...
               <td align="right">
                  <?php echo e($coupon_discount_amount); ?>
...
<?php /**PATH /opt/lampp/htdocs/brobo/resources/views/admin-views/order/order-invoice.blade.php ENDPATH**/ ?>