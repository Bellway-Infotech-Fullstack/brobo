...
<head>
    ...
    <!-- Title -->
    <title><?php echo e(__('messages.error')); ?> 404 | <?php echo e(\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack Food'); ?></title>
    ...
    <div class="footer-height-offset d-flex justify-content-center align-items-center flex-column">
        <div class="row align-items-sm-center w-100">
            ...
            <div class="col-sm-6 col-md-4 text-center text-sm-left">
                ...
                <p class="lead"><?php echo e(__('messages.404_warning_message')); ?>.</p>
                <?php if(auth('vendor')->check()): ?>
                    <a class="btn btn-primary" href="<?php echo e(route('vendor.dashboard')); ?>"><?php echo e(__('messages.dashboard')); ?></a>
                <?php else: ?>
                    <a class="btn btn-primary" href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('messages.dashboard')); ?></a>
                <?php endif; ?>
            </div>
        </div>
        <!-- End Row -->
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="<?php echo e(route('contact-us')); ?>"><?php echo e(\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack Food'); ?> <?php echo e(__('messages.support')); ?></a>
        </li>
    </ul>
</div>
<!-- End Footer -->
...
<?php /**PATH /opt/lampp/htdocs/brobo/resources/views/errors/404.blade.php ENDPATH**/ ?>