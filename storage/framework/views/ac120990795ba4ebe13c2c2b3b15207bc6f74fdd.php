                ...
                <form action="<?php echo e(route('admin.business-settings.update-setup')); ?>" method="post"
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(__('messages.scheduled')); ?> <?php echo e(__('messages.orders')); ?></label><small style="color: red">
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="schedule_order"><?php echo e(__('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="schedule_order2"><?php echo e(__('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(__('messages.admin')); ?> <?php echo e(__('messages.order')); ?> <?php echo e(__('messages.notification')); ?></label><small style="color: red">*</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="admin_order_notification"
                                                   id="aon1" <?php echo e($admin_order_notification==1?'checked':''); ?>>
                                            <label class="custom-control-label" for="aon1"><?php echo e(__('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="admin_order_notification"
                                                   id="aon2" <?php echo e($admin_order_notification==0?'checked':''); ?>>
                                            <label class="custom-control-label" for="aon2"><?php echo e(__('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(__('messages.customer')); ?> <?php echo e(__('messages.verification')); ?></label><small style="color: red"><span
                                        class="input-label-secondary" title="<?php echo e(__('messages.customer_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(__('messages.customer_varification_toggle')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="ev1"><?php echo e(__('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="ev2"><?php echo e(__('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(__('messages.order')); ?>  <?php echo e(__('messages.verification')); ?></label><small style="color: red"><span
                                        class="input-label-secondary" title="<?php echo e(__('messages.order_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(__('messages.order_varification_toggle')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="odc1"><?php echo e(__('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="odc"
                                                   id="odc2" <?php echo e($odc==0?'checked':''); ?>>
                                            <label class="custom-control-label" for="odc2"><?php echo e(__('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <?php ($admin_commission=\App\Models\BusinessSetting::where('key','admin_commission')->first()); ?>
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize" for="admin_commission"><?php echo e(__('messages.default_admin_commission')); ?></label>
                                <input type="number" name="admin_commission" class="form-control" id="admin_commission" value="<?php echo e($admin_commission?$admin_commission->value:0); ?>" min="0" max="100" required>
                            </div>
                        </div>
