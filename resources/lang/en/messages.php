...
return [
    ...
    'alert_restaurant_out_from_campaign'=> 'You want your vendor out from this campaign?',
    ...
    'admin' => 'Admin',
    'admin_or_employee_signin'=>'Admin Sign in',
    ...
    'minimum_delivery_time'=>'Minimum service time (Minutes)',
    'maximum_delivery_time'=>'Maximum service time (Minutes)',
    'availability'=>'availability',
    'banner' => 'Banner',
    'banner_status_updated' => 'Banner status updated',
    'banner_updated_successfully' => 'Banner updated successfully',
    'banner_beleted_successfully' => 'Banner deleted successfully',
    'banners' => 'Banners',
    'balance'=> 'Balance',
    ...
    'collect'=>'Collect',
    'collected_cash_by_restaurant'=>'Collected cash by vendor',
    'collect_cash_from_restaurant'=>'Collect cash from vendor',
    ...
    'confirm_this_order'=>'Confirm this Booking',
    'cancel_this_order'=>'Cancel this Booking',
    'coupon'=>'Coupon',
    'coupons'=>'Coupons',
    ...
    'dm_maximum_order'=>'Maximum assigned bookings for delivery man',
    'dm_maximum_order_hint'=>'Number of maximum bookings a delivery man can serve at a time',
    'dm_maximum_order_exceed_warning'=>'Delivery man maximum serving bookings exceed!',
    ...
    'edit_restaurant'=>'Edit vendor',
    'edited'=>'edited',
    'extra_discount'=>'Extra Discount',
    'failed' => 'Failed',
    'faield_to_create_order_transaction'=>'Failed to create booking transaction!',
    'failed_to_import_data'=>'Filed to import data!',
    'failed_to_place_order'=>'Failed to place booking! Please try again.',
    'faield_to_send_sms'=>'Failed to send SMS',
    'filter'=>'filter',
    'first_name'=>'First name',
    'first_order'=>'First booking',
    ...
    'product_imported_successfully'=>':count - Services imported successfully!',
    ...
    'location'=>'Location',
    'login' => 'login',
    'restaurant_application'=>'Vendor Application',
    'restaurant_required_warning'=>'Make sure you have selected a vendor first!',
    'restaurant_temporarily_closed'=>'Vendor temporarily closed sucessfully',
    'restaurant_temporarily_closed_title'=>'Vendor temporarily closed',
    'Vendor_temporarily_closed_title'=>'Vendor temporarily closed',
    'restaurant_opened'=>'Vendor opened successfully',
    'restaurant_settings_updated'=>'Vendor settings updated!',
    'restaurant_registration'=>'Vendor Registration',
    ...
    'select_zone_for_map'=>' Select a zone based on your vendor location. After selecting the zone you can see the zone on the map',
    'show_hide_Service_menu'=>'By disable it, vendor will not be able to manage (edit, update, delete or change status) any Service but can view all Services.',
    'show_hide_reviews_menu'=>'Show or hide reviews menu from vendor panel.',
    'show_locations_on_map'=>'Show locations on map',
    'system'=>'System',
    'restaurant_lat_lng_warning'=>'Select your vendor exact location from the map (Just click on the map for pick location). The location must be inside the selected zone.',
    ...
    'order_varification_toggle'=>'If this field is active then customer have to provide a OTP code to delivery man for delivered a booking successfully',
    'order_confirmation_model'=>'Booking confirmation model',
    'order_confirmation_model_hint'=>'Selected model will show the pending bookings first and can confirm them',
    'restaurant_data_updated'=>'Vendor data updated successfully!',
    'restaurant_settings_updated'=>'Vendor settings updated!',
    'restaurant_not_found'=>'Vendor not found!',
    ...
    'new_order_push_description'=>'New booking placed',
    'normal'=>'Normal',
    'optional'=>'Optional',
    ...
    'order_ammount_with_delivery_charge'=>'booking ammount with delivery charge',
    'out_for_delivery' => 'Service Ongoing',
    ...
    'please_select_restaurant'=>'Please select a vendor!',
    'read_more'=>'Read More...',
    'select_category'=>'Select Category',
    'select_date'=>'select date!',
    'select_restaurant'=>'select Vendor',
    ...
    'product_added_successfully'=>'Service added successfully',
    'product_updated_successfully'=>'Service updated successfully',
    'product_deleted_successfully'=>'Service deleted successfully',
    'product_status_updated'=>'Service status updated',
    ...
    'required'=>'required',
    'restaurant'=>'Vendor',
    'restaurant_commission'=>'Vendor commission',
    'vendor_commission'=>'Vendor commission',
    'restaurant_view'=>'Vendor view',
    'restaurant_is_closed_at_order_time'=>'Vendor is closed at booking time',
    'restaurant_owner_login_form'=>'Vendor Owner Login Form',
    'vendor_owner_login_form'=>'Vendor Login Form',
    'returned' => 'Returned',
    'reviews'=>'Reviews',
    ...
    'scheduled'=> 'Scheduled',
    'schedule_order_not_available'=>'Schedule booking not available',
    'scheduled_date_is_restaurant_offday'=>'Sorry! booking scheduled date is vendor offday. Please chose another date',
    'secret' => 'secret',
    ...
    'signin'=>'Signin',
    'sign_in_as_employee'=>'Sign in as Vendor Employee',
    'sign_in_as_owner'=>'Sign in as Vendor',
    ...
    'accepted'=>'Accepted',
    'acceptedbyDM'=>'Accepted',
    'preparingInRestaurants'=>'Service Preparing in Vendors',
    'ServiceOnTheWay'=> 'Service on the Way',
    'refundRequest'=>'Refund Request',
    'refunded'=>'Refunded',
    'refund_this_order'=>'Refund this booking',
    'senang'=> 'Senang',
    'pay'=> 'Pay',
    'send'=>'Send',
    'settings'=>'Settings',
    ...
    'order_can_not_cancle_after_confirm'=>'You can not cancle a booking after confirmed!',
    ...
    'welcome'=>'Welcome',
    'welcome_message'=>'Hello, here you can manage your bookings by zone.',
    'employee_welcome_message'=>'Hello, here you can manage your vendors.',
    ...
    'daily'=>'daily',
    'status'=>'Status',
    'top_selling_Services' => 'Top Booking Services',
    'top_rated_Services' => 'Top Booking Services',
    '#'=>'#',
    'action'=>'Action',
    'actions'=>'Actions',
    'download'=>'Download',
    ...
    'service' => 'Service',
    'services' => 'Products',
    'serviceOngoing' => 'Service Ongoing',
    'available'=>'Available',
    'time'=>'time',
    'starts'=>'starts',
    'ends'=>'ends',
    ...
    'on'=>'on',
    'off'=>'off',
    'order_canceled_successfully'=>'Booking canceled successfully!',
    'order_placed_successfully'=>'Booking placed successfully!',
    'order_updated_successfully'=>'Booking updated successfully!',
    'order_varification_code_not_matched'=>'Booking varification code not matched',
    'order_varification_code_is_required'=>'Booking varification code is required',
    'order_data_not_found'=>'Booking data not found',
    'phone'=>'Phone',
    ...
    'Service_section'=>'Manage Product',
    'Service_status_updated'=>'Product status updated!',
    'Service_not_found'=>'Product not found',
    'charge'=>'Charge',
    'campaign'=>'Campaign',
    'campaigns'=>'Campaigns',
    'campaign_order'=>'Campaign Booking',
    ...
    'restaurants'=>'Vendors',
    'restaurant_added_to_campaign'=>'Vendor added to Campaign!',
    'restaurant_imported_successfully'=>':count - Vendors imported successfully!',
    'restaurant_remove_from_campaign'=>'Vendor removed from Campaign!',
    'restaurant_wise'=>'Vendor wise',
    ...
    'not_fund'=>'Not found!',
    'food_status_updated' => 'Service Updated',
    'no_more_orders'=>'No more bookings!',
    ...
    'you_can_not_cancel_a_completed_order'=>'You can not cancel a completed booking',
    'you_can_not_cancel_a_order'=>'You can not cancel a booking',
    'you_can_not_cancel_after_confirm'=>'You can not cancle after confirmed!',
    'you_can_not_delivered_delivery_order'=>'You can not delivered a booking!',
    'you_can_not_edit_this_zone_please_add_a_new_zone_to_edit'=>'Sorry!You can not edit this zone. Please add a new zone to edit',
    'you_can_not_edit_this_restaurant_please_add_a_new_restaurant_to_edit'=>'Sorry!You can not edit this vendor. Please add a new vendor to edit',
    'you_can_not_delete_this_restaurant_please_add_a_new_restaurant_to_delete'=>'Sorry!You can not delete this vendor. Please add a new vendor to delete',
    ...
    'you_want_to_temporarily_close_this_restaurant'=>'You want to temporarily close this vendor?',
    'you_want_to_open_this_restaurant'=>'You want to change the active status to open for this vendor?',
    'you_want_to_update_this_order_item'=>'You want to update this booking item?',
    'you_want_to_remove_this_order_item'=>'You want to remove this booking item?',
    'you_want_to_edit_this_order'=>'You want to edit this booking?',
    'you_want_to_cancel_editing'=>'You want to cancel editing this booking?',
    'you_want_to_submit_all_changes_for_this_order'=>'You want to submit all changes for this booking?',
    ...
    'you_can_not_refund_a_cod_order'=>'Sorry cash on delivery or unpaid booking can not be refunded!',
    'already_confirmed'=>'This booking is already confirmed!',
    'already_submitted'=>'Already submitted!',
    'cannot_change_status_after_delivered'=>'Sorry! You can not change the status after delivered a booking.',
    'assign_delivery_mam_manually'=>'Assign delivery man munally',
    'total_served_order'=>'Total served bookings',
    'orders_served'=>'Bookings served',
    'orders_delivered'=>'bookings completed',
    'order_confirmation_warning'=>'You are not allowed to confirm this booking',
    'order_updated_successfully'=>'Booking updated successfully',
    'top_selling_Services'=>'Top Booking Services',
    'top_content_image'=>'Top Content Image',
    'popular_restaurants'=>'Popular vendors',
    'popular_vendors'=>'Popular vendors',
    'most_reviewed_Services'=>'Most Reviewed Services',
    'new_business'=>'New Business',
    'new_campaign'=>'New Campaign',
    'new_category'=>'New Category',
    'new_coupon'=>'New coupon',
    'new_Service'=>'New Service',
    'new_restaurants'=>'New vendors',
    ...
    'most_reviewed_services' => 'Most Reviewed Services',
    'total_sell'=>'Total Booking',
    'total_order_amount'=>'Total booking amount',
    'total_uses'=>'Uses Count',
    'kyc_details' => 'KYC',
    'top_rated_Services'=>'Most rated Services',
    'top_deliveryman'=>'Top delivery man by booking count',
    'top_customers'=>'Top customers',
    'top_restaurants'=>'Top vendors by booking completed',
    'top_vendors'=>'Top vendors by bookings completed',
    'commission_earned'=>'Commission Earned',
    'admin_commission'=>'Admin commission',
    'refund_requested'=>'Refund Requested',
    'can_not_add_both_Service_and_restaurant_at_same_time'=>'Can not add both Service and vendor at same time!',
    ...
    'dashboard_order_statistics'=>'Dashboard booking statistics',
    'cooking'=>'Processing',
    'ready_for_delivery'=>'Ready for service',
    'Service_on_the_way'=>'Service ongoing',
    'Services_ongoing' => 'Service ongoing',
    'yearly_statistics'=>'Yearly Statistics',
    'commission_given'=>'Commission Given',
    'followup'=>"Followup your Services performance",
    'Want_to_delete_this_role'=>'Want to delete this role ?',
    'Want_to_delete_this_item'=>'Want to delete this item ?',
    'you_are_unassigned_from_a_order'=>'You are unassigned from a booking',
    'you_are_assigned_to_a_order'=>'You are assigned to a booking',
    'you_can_not_schedule_a_order_in_past'=>'You can not schedule a booking in past time',
    'you_can_schedule_a_order_only_in_future_time'=>'You can schedule a booking only in future time',
    'You_can_not_change_status_after_picked_up_by_delivery_man'=>'You can not change status after picked up by delivery man!',
    'you_can_not_deliver_a_delivery_order'=>'You can not deliver a booking which is not self pick up!',
    'you_need_to_order_at_least'=>'You need to booking at least :amount.',
    'you_want_to_change_this_restaurant_status'=>'You want to change status for this vendor status?',
    ...
    'trusted_by_restaurant'=>'Vendor Owner',
    ...
    'thirsday'=>'Thursday',
    'friday'=>'Friday',
    'restaurant_cancellation_toggle'=>'Vendor can cancel a booking',
    'vendor_cancellation_toggle'=>'Vendor can cancel a booking',
    'deliveryman_cancellation_toggle'=>'Deliveryman can cancel a booking',
    'time_zone'=>'Time Zone',
    'time_format'=>'Time Format',
    '12_hour'=>'12H',
    '24_hour'=>'24H',
    'language'=>'Language',
    'show_earning_for_each_order'=>'Show earning for each booking (Deliveryman app)',
    'order_canceled_confirmation'=>'You want to cancel this booking?',
    ...
    'vendor_employee_login_form'=>'Vendor Employee Login Form',
    'add_new_restaurant'=>'Add new vendor',
    ...
    'product_unavailable_warning'=>'One or more Services in your cart is not available. Please clear your cart and try again.',
    ...
    'restaurant_self_registration'=>'Vendor self registration',
