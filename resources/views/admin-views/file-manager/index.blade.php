    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-12">
            ...
            <div class="card-header py-1">
                ...
                @endphp
                    <h5 class="text-capitalize">{{end($pwd) == 'restaurant' ? 'Vendor' : end($pwd)}} <span class="badge badge-soft-dark ml-2" id="itemCount">{{count($data)}}</span></h5>
                ...
                <div class="card-body" style="padding: 0">
                    <div class="row">
                        ...
                        @if(!in_array($file['name'], ['product', 'delivery-man', 'restaurant']))
                        <div class="col-sm-2">
                            @if($file['type']=='folder')
                            <a class="btn"  href="{{route('admin.file-manager.index', base64_encode($file['path']))}}">
                                <img class="img-thumbnail" src="{{asset($assetPrefixPath . '/admin/img/folder.png')}}" alt="">
                            ...
                            <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal{{$key}}" title="{{$file['name']}}">
                                ...
                                <p style="overflow:hidden">{{Str::limit($file['name'],10) == 'restaurant' ? 'Vendor' : Str::limit($file['name'],10) }}</p>
                            </button>
