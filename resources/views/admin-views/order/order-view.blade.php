                ...
                <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="col-6 pt-2">
                                ...
                                @if ($order->order_attachment)
                                    ...
                                    <button class="btn w-100" data-toggle="modal" data-target="#imagemodal"
                                        title="{{ __('messages.order') }} {{ __('messages.attachment') }}">
                                        <div class="gallary-card">
                                            <img src="{{ asset('storage/app/' . 'public/order/' . $order->order_attachment) }}"
                                                alt="{{ __('messages.prescription') }}" style="height:auto;width:50%;">
                                        </div>
                                    </button>
                                                ...
                                                <div class="modal-footer">
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.file-manager.download', base64_encode('public/order/' . $order->order_attachment)) }}"><i
                                                            class="tio-download"></i> {{ __('messages.download') }} </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        @if ($order->order_type=='parcel')
                            ...
                            ?>
                            <div class="media">
                                <div class="avatar avatar-xl mr-3" title="{{ $order->parcel_category?$order->parcel_category->name:__('messages.parcel_category_not_found') }}">
                                    <img class="img-fluid"
                                ...
                                <div class="media-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <strong> {{ Str::limit($order->parcel_category?$order->parcel_category->name:__('messages.parcel_category_not_found'), 25, '...') }}</strong><br>
                                            <div class="font-size-sm text-body">
                                                <span>{{ $order->parcel_category?$order->parcel_category->description:__('messages.parcel_category_not_found') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="media">
                                        ...
                                        $total_item_price = $total_item_price + $detail['item_price'];
                                         ?>
                                            ...
                                            <img class="img-fluid" src="{{ $detail['item_image']}}"  alt="Image Description">
                                        ...
                                        <div class="media-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3 mb-md-0">
                                                    <strong>
                                                        {{ Str::limit($detail['item_name'], 20, '...') }}</strong><br>
                                                </div>

                                                <div class="col col-md-2 align-self-center">
                                                    <h6>    Rs . {{ $detail['item_price'] / $detail['quantity'] }}
                                                    </h6>
                                                </div>
                                                <div class="col col-md-1 align-self-center">
