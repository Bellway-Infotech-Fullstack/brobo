...
$item_color_image_id = $items[0]->coloredImages[0]->id;
    ...
    <div class="d-flex flex-row">
        ...
        <div class="d-flex align-items-center justify-content-center active" style="height:9.5rem;">
            <img class="img-responsive" style="height:100%;width:auto;overflow:hidden;border-radius: 5%;"
                src="{{$productImagePath}}"   alt="Product image" id="main_image">
        ...
        <div class="details pl-2">
            <a  class="h3 mb-2 product-title">{{$product->name}}</a>
...
<script type="text/javascript">function displayImage(img_src,ele){
