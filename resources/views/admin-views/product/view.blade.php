    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{route('admin.service.edit',[$product['id']])}}" class="btn btn-primary float-right">
            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-sm-3 border-left text-center">
                        ...
                        @if($product->vendor)
                        <a href="{{route('admin.vendor.view', $product->vendor_id)}}" title="{{$product->vendor['name']}}">
                            <img
                                class="avatar-img avatar-circle" style="width: 75px;margin:auto;"
                                onerror="this.src='{{asset('public/assets/admin/img/160x160/img1.jpg')}}'"
                                src="{{asset('storage/app/public/restaurant/'.$product->vendor->image)}}"
                                alt="Image Description">
                            <label class="input-label">{{$product->vendor['name']}}</label>
                        </a>
                        @else
                    ...
                    @foreach($reviews as $review)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('admin.service.reviews.status',[$review['id'],$review->status?0:1])}}" method="get" id="status-{{$review['id']}}">
                                </form>
                            </td>
                        </tr>
                    @endforeach
