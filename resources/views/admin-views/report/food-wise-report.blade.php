        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{__('messages.service_wise_report')}} <span class="h6 badge badge-soft-success ml-2" id="itemCount">( {{session('from_date')}} - {{session('to_date')}} )</span></h1>
                </div>
                ...
                <div class="col-sm-auto" style="width: 306px;">
                    <select name="restaurant_id" onchange="set_restaurant_filter('{{url()->full()}}',this.value)" data-placeholder="{{__('messages.select')}} {{__('messages.restaurant')}}" class="js-data-example-ajax form-control">
                        ...
                        @else
                        <option value="all" selected>{{__('messages.all')}} {{__('messages.vendors')}}</option>
                        @endif
                    </select>
                </div>
            </div>
