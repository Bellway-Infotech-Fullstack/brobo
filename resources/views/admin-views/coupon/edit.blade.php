            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select name="coupon_type" class="form-control" onchange="coupon_type_change(this.value)">
                                    <option value="service_wise" {{$coupon['coupon_type']=='service_wise'?'selected':''}}>{{__('messages.service')}} {{__('messages.wise')}}</option>
                        ...
                        <div class="col-4">
                            <div class="form-group" id="restaurant_wise" style="display: {{$coupon['coupon_type']=='service_wise'?'block':'none'}}">
                                    <label class="input-label" for="exampleFormControlSelect1">{{__('messages.service')}}<span
                                            class="input-label-secondary"></span></label>
                                    <select name="service_ids[]" class="js-data-example-ajax form-control"  title="Select Service">
                                    @if($coupon->coupon_type == 'service_wise')
                                    @php($service=\App\Models\Service::find(json_decode($coupon->data)[0]))
                                        @if($service)
