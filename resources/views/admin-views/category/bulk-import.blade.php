...
@section('title','Categories Bulk Export')
...
@section('content')
    <div class="content container-fluid">
        ...
        <h1 class="text-capitalize">{{__('messages.categories')}} {{__('messages.bulk_export')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
                ...
                <form class="product-form" action="{{route('admin.category.bulk-import')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            ...
                            <a href="{{asset($assetPrefixPath . '/categories_bulk_format.xlsx')}}" download=""
