        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{__('messages.vendors')}} <span class="badge badge-soft-dark ml-2" id="itemCount">{{$vendors->total()}}</span></h1>
                </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    ...
                    <div class="card-header pb-1 pt-1" >
                        <h5>{{__('messages.vendors')}} {{__('messages.list')}}</h5>
                                    ...
                                    <td>
                                        <div style="height: 60px; width: 60px; overflow-x: hidden;overflow-y: hidden">
                                            ...
                                            <img width="60" style="border-radius: 50%; height:100%;"
                                                 ...
                                                 src="{{asset('storage/app/public/restaurant')}}/{{$dm['image']}}"></a>
                                        </div>
                                    </td>
                                 {{--    <td>
                                        <a href="{{route('admin.vendor.view', $dm->id)}}" alt="view restaurant">
