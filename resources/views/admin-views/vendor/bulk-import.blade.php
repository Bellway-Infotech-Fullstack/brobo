...
@section('title','Vendor Bulk Import')
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.vendor.list')}}">{{trans('messages.vendors')}}</a>
                </li>
                <li class="breadcrumb-item">{{trans('messages.bulk_import')}} </li>
            </ol>
        </nav>
        <h1 class="text-capitalize">{{__('messages.vendors')}} {{__('messages.bulk_import')}}</h1>
        <!-- Content Row -->
        <div class="row">
            <div class="col-12">
                <div class="jumbotron pt-1" style="background: white">
                    ...
                    <p>4. After uploading vendors you need to edit them and set vendors's logo and cover.</p>

                    <p>5. You can get category and zone id from their list, please input the right ids.</p>

                    <p>6. You can upload your vendor images in vendor folder from gallery, and copy image`s path.</p>
                    
                    <p>7. Default password for vendor is 12345678.</p>
                ...
                <form class="product-form" action="{{route('admin.vendor.bulk-import')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4>Import vendors File</h4>
                            <a href="{{asset($assetPrefixPath . '/vendors_bulk_format.xlsx')}}" download=""
