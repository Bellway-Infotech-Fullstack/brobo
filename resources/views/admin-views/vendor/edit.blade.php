            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.vendor.update',[$vendor['id']])}}" method="post" class="js-validate"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="avatar avatar-xxl avatar-border-lg">
                                    <img id="panCardCoverImageViewer" class="avatar-img" onerror="this.src='{{asset($assetPrefixPath . '/admin/img/160x160/img1.jpg')}}'"
                    ...
                    <center>
                        ...
                        onerror="this.src='{{asset($assetPrefixPath . '/admin/img/900x400/img1.jpg')}}'"
