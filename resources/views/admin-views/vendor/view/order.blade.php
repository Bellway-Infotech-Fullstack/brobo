...
@section('title',$vendor->names()."'s Orders")
    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.vendor.view', ['vendor'=>$vendor->id, 'tab'=> 'order'])}}"  aria-disabled="true">{{__('messages.order')}}</a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="card-body mb-3 mb-lg-5">
                            <div class="row gx-lg-4">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.order.list',['pending'])}}?vendor[]={{$vendor->id}}'">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.pending')}}</h6>
                                            <span class="card-title h3">
                                            {{\App\Models\Order::where(['order_status'=>'pending','vendor_id'=>$vendor->id])->count()}}</span>
                                        </div>
                                ...
                                <div class="col-sm-6 col-lg-3 column-divider-sm">
                                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.order.list',['delivered'])}}?vendor[]={{$vendor->id}}'">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.delivered')}}</h6>
                                            <span class="card-title h3">{{\App\Models\Order::where(['order_status'=>'delivered', 'vendor_id'=>$vendor->id])->count()}}</span>
                                        </div>
                                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                                ...
                                <div class="col-sm-6 col-lg-3 column-divider-lg">
                                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.order.list',['scheduled'])}}?vendor[]={{$vendor->id}}'">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.scheduled')}}</h6>
                                            <span class="card-title h3">{{\App\Models\Order::Scheduled()->where('vendor_id', $vendor->id)->count()}}</span>
                                        </div>
                                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                                        <i class="tio-clock"></i>
                                        </span>
                                ...
                                <div class="col-sm-6 col-lg-3 column-divider-sm">
                                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.order.list',['all'])}}?vendor[]={{$vendor->id}}'">
                                        <div class="media-body">
                                            <h6 class="card-subtitle">{{__('messages.all')}}</h6>
                                            <span class="card-title h3">{{\App\Models\Order::where('vendor_id', $vendor->id)->count()}}</span>
                                        </div>
                                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                                        <i class="tio-table"></i>
                                        </span>
