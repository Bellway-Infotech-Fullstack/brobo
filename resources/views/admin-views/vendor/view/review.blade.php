    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('admin.vendor.view', ['vendor'=>$vendor->id, 'tab'=> 'reviews'])}}"  aria-disabled="true">{{__('messages.reviews')}}</a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
                ...
                <div class="col-md-12">
                    <div class="card h-100">
                        <div class="card-header">
                            {{__('messages.reviews')}} {{$vendor->reviews->count()}}
                        </div>
                        <div class="table-responsive datatable-custom">
                            <table id="columnSearchDatatable"
                                ...
                                <tbody id="set-rows">
                                @php($reviews = \App\Models\Review::whereHas('service', function($query)use($vendor){
                                ...
                                @foreach($reviews as $key=>$review)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="media align-items-center" href="{{route('admin.service.view',[$review->service['id']])}}">
                                                <img class="avatar avatar-lg mr-3" src="{{asset('storage/app/public/product')}}/{{$review->service['image']}}" 
                                                    onerror="this.src='{{asset($assetPrefixPath . '/admin/img/160x160/img2.jpg')}}'" alt="{{$review->service->name}} image">
                                                <div class="media-body">
                                                    <h5 class="text-hover-primary mb-0">{{Str::limit($review->service['name'],10)}}</h5>
                                                </div>
                                            </a>
                                        </td>
                                        <td>
