        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('admin.campaign.add-new', 'service_campaigns')}}">
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($campaigns as $key=>$campaign)
                                <tr>
                                    ...
                                    <td>
                                        <span class="d-block text-body"><a href="{{route('admin.campaign.view',['service_campaigns',$campaign->id])}}">{{$campaign['title']}}</a>
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="campaignCheckbox{{$campaign->id}}">
                                            <input type="checkbox" onclick="location.href='{{route('admin.campaign.status',['service_campaigns',$campaign['id'],$campaign->status?0:1])}}'"class="toggle-switch-input" id="campaignCheckbox{{$campaign->id}}" {{$campaign->status?'checked':''}}>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-white"
                                            href="{{route('admin.campaign.edit',['service_campaigns',$campaign['id']])}}" title="{{__('messages.edit')}} {{__('messages.campaign')}}"><i class="tio-edit"></i>
                                        </a>
