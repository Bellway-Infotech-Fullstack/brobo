...
@push('css_or_js')
    ...
    <link href="{{asset($assetPrefixPath . '')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="{{asset($assetPrefixPath . '/css/croppie.css')}}" rel="stylesheet">
    ...
    <div class="row">
        ...
        @if($wr->vendor->restaurants)
            <div class="col-md-4">
                <div class="card" style="min-height: 260px;">
                    <div class="card-header">
                        <h3 class="h3 mb-0">{{trans('messages.service')}} {{trans('messages.info')}}</h3>
                        <i class="tio tio-shop-outlined"></i>
                    </div>
                    <div class="card-body">
                        <h5>{{trans('messages.service')}} : {{$wr->vendor->restaurants[0]->name}}</h5>
