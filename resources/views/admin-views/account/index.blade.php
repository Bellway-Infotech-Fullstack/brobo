        ...
        <div class="card-body">
            <form action="{{route('admin.account-transaction.store')}}" method='post' id="add_transaction">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="input-label" for="restaurant">{{__('messages.vendor')}}<span class="input-label-secondary"></span></label>
                            <select id="restaurant" name="vendor_id" data-placeholder="{{__('messages.select')}} {{__('messages.vendor')}}" onchange="getAccountData('{{url('/')}}/admin/vendor/get-account-data/',this.value,'vendor')" class="form-control" title="Select Vendor" disabled>
                        ...
                        <table id="datatable"
                            ...
                            @foreach($account_transaction as $k=>$at)
                                <tr>
                                    ...
                                    <td>
                                        @if($at->vendor)
                                        <a href="{{route('admin.vendor.view',[$at->vendor['id']])}}">{{ $at->vendor->names() }}</a>
