                        ...
                        <!-- Notification -->
                          ...
                          <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('vendor.notification.index')}}">
                                <i class="tio-notifications"></i>
                                @php($message=\App\Models\VendorNotification::where('is_seen',0)->where('vendor_id', auth('vendor')->id())->count())
                                {{-- @if($message!=0) --}}
                                    <span class="btn-status btn-sm-status btn-status-danger" style="display: inline-block;z-index: 100;height: 20px; width: 20px">{{$message}}</span>
                                {{-- @endif --}}
                            </a>
                        </div>
