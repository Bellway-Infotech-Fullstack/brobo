                ...
                <!-- End Orders -->
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                               title="{{__('messages.vendor')}} {{__('messages.section')}}">{{__('messages.vendor')}} {{__('messages.management')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/vendor*') && !Request::is('admin/vendor/withdraw_list'))?'active':''}}">
                        ...
                        >
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{__('messages.vendors')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/vendor/add')?'active':''}}">
                                ...
                                title="{{__('messages.register')}} {{__('messages.vendor')}}"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{__('messages.add')}} {{__('messages.vendor')}}
                                    </span>
                                </a>
                            </li>
                            ...
                            <li class="navbar-item {{Request::is('admin/vendor/list')?'active':''}}">
                                ...
                                title="{{__('messages.vendor')}} {{__('messages.list')}}"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{__('messages.vendors')}} {{__('list')}}</span>
                                </a>
                            </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/campaign*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/campaign/item/*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.campaign.list', 'service_campaigns')}}"
                    ...
                    @if(\App\CentralLogics\Helpers::module_permission_check('withdraw_list'))
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/vendor/withdraw*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               ...
                               title="{{__('messages.vendor')}} {{__('messages.withdraws')}}"
                            >
                                <i class="tio-table nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{__('messages.vendor')}} {{__('messages.withdraws')}}</span>
                            </a>
                        </li>
                    @endif
                <!-- End withdraw -->
                    ...
                    @if(\App\CentralLogics\Helpers::module_permission_check('report'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/report/food-wise-report')?'active':''}}">
                            <a class="nav-link " href="{{route('admin.report.food-wise-report')}}"
                               title="{{__('messages.service_wise_report')}}">
                                <span class="tio-report nav-icon"></span>
                                <span
                                    class="text-truncate">{{__('messages.service_wise_report')}}</span>
                            </a>
                        </li>
                    @endif
