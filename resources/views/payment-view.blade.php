                                ...
                                <div class="card-body pt-1" style="height: 70px">
                                    ...
                                    <!-- Note that the amount is in paise = 50 INR -->
                                        ...
                                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-amount="{{$payment_type == 'full' ? $order->order_amount*100 : $order->due_amount*100}}"
                                                data-buttontext="Pay {{$payment_type == 'full' ? $order->order_amount : $order->due_amount}} {{\App\CentralLogics\Helpers::currency_code()}}"
