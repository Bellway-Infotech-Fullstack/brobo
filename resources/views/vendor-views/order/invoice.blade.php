        ...
        <div class="row" id="printableArea" style="font-family: emoji;">
            ...
            <div class="col-5">
                <div class="text-center pt-4 mb-3">
                    <h2 style="line-height: 1">{{$order->vendor->names()}}</h2>
                        ...
                        @if($detail->service)
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <div class="font-size-sm text-body">
                                        <span>{{'Price'}} :  </span>
                                        <span class="font-weight-bold">{{\App\CentralLogics\Helpers::format_currency($detail->service->price)}}</span>
                                    </div>
                                    @endif
                ...
                <div class="row justify-content-md-end mb-3" style="width: 97%">
                    <div class="col-md-7 col-lg-7">
                        <dl class="row text-right">
                            <dt class="col-6">Service Price:</dt>
                            ...
                            <dt class="col-6">{{__('messages.tax')}}:</dt>
                            ...
                            <dd class="col-6" style="font-size: 20px">{{\App\CentralLogics\Helpers::format_currency($sub_total+$order['total_tax_amount']+$add_ons_cost-$order['coupon_discount_amount'] - $order['restaurant_discount_amount'])}}</dd>
                        </dl>
                    </div>
                </div>
