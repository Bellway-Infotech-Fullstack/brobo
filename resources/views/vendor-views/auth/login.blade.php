...
<head>
    ...
    <!-- Title -->
    <title>{{__('messages.vendor')}} | {{__('messages.login')}}</title>
...
<main id="content" role="main" class="main">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero"
         style="height: 100%; background-image: url({{asset('public/assets/admin/img/vendor-bg.png')}});background-position: bottom;"
         >
    </div>
    ...
    <div class="container py-0">
       {{--  <a class="d-flex justify-content-center mb-5" href="javascript:">
        ...
        <header class="position-relative d-flex flex-column flex-md-row justify-content-between p-3 mb-5">
            <div class="font-weight-bold order-2 order-md-1">
                <img class="z-index-2" src="{{asset('public/assets/admin/img/hello.png')}}" style="max-height: 50px;max-width: 200px">
                <h2 style="color: yellow;">Please Provide The Best Service</h2>
                <h3 style="color: #fff;">So That We Can Provide More Bookings</h3>
            </div>
            <a class="d-flex justify-content-center mb-5 order-1 order-md-2" href="javascript:">
                <img class="z-index-2" src="{{asset('public/assets/admin/img/logo_white.png')}}"
                      alt="Image Description" style="max-height: 50px;max-width: 200px">
            </a>
        </header>
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                       {{--  <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4">{{__('messages.vendor')}} {{__('messages.sign_in')}}</h1>
                        ...
                        <form class="login_form" action="{{route('vendor.auth.login')}}" method="post" id="vendor_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{__('messages.vendor_owner_login_form')}}</span>
                                </div>
                            </div>
                        ...
                        <form class="login_form" action="{{route('vendor.auth.employee.login')}}" method="post" id="employee_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{{__('messages.vendor_employee_login_form')}}}</span>
                                </div>
                            </div>
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
        ...
        <footer class="d-block position-relative bottom-0 w-100 d-flex flex-column flex-md-row justify-content-between mt-5 pt-3">
            <div class="d-flex justify-content-center align-items-center text-light py-1">
                <img class="z-index-2" src="{{asset('public/assets/admin/img/certified.png')}}"
                      alt="Image Description" style="max-height: 50px;max-width: 200px">
                <h2 style="color: #fff;font-weight: 500;" class="pl-2">Certified</h2>
            </div>

            <div class="d-flex justify-content-center align-items-center text-light py-1">
                <h2 style="color: #fff;font-weight: 500;" class="pr-2 order-2 order-md-1">100% Safe & Secured</h2>
                <img class="z-index-2 order-1 order-md-2" src="{{asset('public/assets/admin/img/secure.png')}}"
                      alt="Image Description" style="max-height: 50px;max-width: 200px">
            </div>
        </footer>
    </div>
