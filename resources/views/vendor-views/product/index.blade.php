...
@section('content')
    @php
        ...
        $closing_time=$closing_time?$closing_time : $closing_time;
    @endphp
                        ...
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <select name="category_id" class="form-control js-select2-custom"
                                        onchange="getRequest('{{url('/')}}/vendor-panel/service/get-categories?parent_id='+this.value,'sub-categories')">
                        ...
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <select name="sub_category_id" id="sub-categories"
                                        ...
                                        onchange="getRequest('{{url('/')}}/vendor-panel/service/get-categories?parent_id='+this.value,'sub-sub-categories')">
...
@push('script_2')
    ...
    <script>
        ...
        function combination_update() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('vendor.service.variant-combination')}}',
    ...
    <script>
        $('#food_form').on('submit', function () {
            ...
            $.post({
                url: '{{route('vendor.service.store')}}',
                data: $('#food_form').serialize(),
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (data) {
                    ...
                    if (data.errors) {
                        ...
                        setTimeout(function () {
                            location.href = '{{route('vendor.service.list')}}';
                        }, 2000);
                    }
                }
            });
