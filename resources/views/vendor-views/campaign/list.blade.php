...
@section('content')
@php($vendor_id = \App\CentralLogics\Helpers::get_restaurant_id())
                            ...
                            @foreach($campaigns as $key=>$campaign)
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        <!-- <button type="button" onclick="location.href='{{route('vendor.campaign.remove-restaurant',[$campaign['id'],$vendor_id])}}'" title="You are already joined. Click to out from the campaign." class="btn btn-outline-danger">Out</button> -->
                                        ...
                                        <form action="{{route('vendor.campaign.remove-restaurant',[$campaign['id'],$vendor_id])}}"
                                        ...
                                        <form action="{{route('vendor.campaign.addrestaurant',[$campaign['id'],$vendor_id])}}"
                                                method="GET" id="campaign-{{$campaign['id']}}">
                                            @csrf 
                                        </form>
                                        @endif
