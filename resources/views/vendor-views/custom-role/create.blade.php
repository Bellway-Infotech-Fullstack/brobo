...
<div class="content container-fluid"> 
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h3 mb-0 text-black">{{__('messages.employee')}} {{__('messages.Role')}}</h1>
    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="service" class="form-check-input"
                                           id="service">
                                    <label class="form-check-label input-label qcont" for="service">{{__('messages.service')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="booking" class="form-check-input"
                                           id="booking">
                                    <label class="form-check-label input-label qcont" for="booking">{{__('messages.booking')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="vendor_setup" class="form-check-input"
                                           id="vendor_setup">
                                    <label class="form-check-label input-label qcont" for="vendor_setup">{{__('messages.vendor')}} {{__('messages.setup')}}</label>
                                </div>
                            </div>
                          {{--   <div class="col-md-3">
                                <div class="form-group form-check">
