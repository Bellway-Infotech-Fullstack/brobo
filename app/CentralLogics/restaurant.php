...
class RestaurantLogic
{
    ...
    {
        $paginator = Restaurant::selectRaw('*, IF((opening_time < "'.now()->format('H:i').'" and closing_time > "'.now()->format('H:i').'"), true, false) as open')
    ...
    public static function format_export_restaurants($restaurants)
    {
        ...
        foreach($restaurants as $item)
        {
            ...
            $storage[] = [
                ...
                'closeingTime'=>$item->restaurants[0]->closing_time->format('H:i:s'),
