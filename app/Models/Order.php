...
class Order extends Model
{
    ...
    protected $fillable = ['start_date', 'end_date','time_duration', 'user_id','status','cart_items','paid_amount','pending_amount','delivery_address_id','coupon_id','delivery_charge','order_installment_percent','transaction_id','order_id','description','extended_order_transaction_id','final_item_price','damage_amount','labour_charge','damage_order_transaction_id','is_building_have_lift','due_amount_transaction_id','referred_code','refunded', 'referral_code','delivery_charge'];
